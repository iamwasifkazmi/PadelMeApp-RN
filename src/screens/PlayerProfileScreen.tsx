...
const styles = StyleSheet.create({
  ...
  avatar: { width: 82, height: 82, borderRadius: 41, backgroundColor: "#0f172a", alignItems: "center", justifyContent: "center" },
  avatarText: { color: "#fff", fontSize: 30, fontWeight: "800" },
  name: { marginTop: 12, fontSize: 22, fontWeight: "800", color: "#0f172a" },
  location: { marginTop: 4, color: "#64748b", fontSize: 13 },
  statsRow: { flexDirection: "row", gap: 8, marginBottom: 12 },
  statCard: { flex: 1, backgroundColor: "#fff", borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 14, paddingVertical: 12, alignItems: "center" },
  statTitle: { fontSize: 11, color: "#64748b", fontWeight: "600" },
  statValue: { marginTop: 5, fontSize: 16, color: "#0f172a", fontWeight: "800", textTransform: "capitalize" },
  friendBtn: { backgroundColor: "#2563eb", borderRadius: 12, alignItems: "center", justifyContent: "center", paddingVertical: 12 },
