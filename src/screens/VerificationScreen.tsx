...
const styles = StyleSheet.create({
  ...
  status: { marginBottom: 10, color: "#0f172a", textTransform: "capitalize", fontWeight: "700" },
  ...
  btn: { backgroundColor: "#2563eb", borderRadius: 12, alignItems: "center", justifyContent: "center", paddingVertical: 12 },
